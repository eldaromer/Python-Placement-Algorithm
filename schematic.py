...
class schematic():
    ...
    #         toPlot = assemble(self.listBitblox())
    #         print "Rendering solution..."
    #         drawBB(self.listBitblox(), grid = False, center = toPlot.findCenterFGU())
    #     else:
    #         print "No solutions are stored!"
    ...
    def expandLast(self):
        self.expand(len(self.cn) - 1)

    def countFGU(self):
        count = 0
        for bb in self.listBitblox():
            count += len(bb.FGU_list)
        return count